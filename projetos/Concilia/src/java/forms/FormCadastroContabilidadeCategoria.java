...
@Named("formCadastroContabilidadeCategoria")
@ViewScoped
public class FormCadastroContabilidadeCategoria implements Serializable {
...
// ---------------------------------------------------------------- CONSTRUCTOR    
    public FormCadastroContabilidadeCategoria() {
        geraLista();
    }
