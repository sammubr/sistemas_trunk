...
@Named("relatorioMovimentosBancarios")
@ViewScoped
public class RelatorioMovimentosBancarios implements Serializable {
    ...
    public RelatorioMovimentosBancarios() {
    ...
    public StreamedContent getArquivoRetorno() throws ParseException {
        ...
        String nomeRelatorioJasper = "MovimentosBancarios";
        String nomeRelatorioSaida = "MovimentosBancarios";
